                    ...
                    <div class="col-lg-auto col-12 d-flex justify-content-center">
                        <ul class="header-top-menu">
                            ...
                            <form action="{{route('logout')}}" method="POST">
                                @csrf
                                <li> <button type="submit" class="dropdown-item"><i class="fa fa-sign-out"></i> Sign
                                        out</button></li>
                            </form>
            ...
            <div class="container">
                <div class="row position-relative justify-content-between align-items-center">
                    ...
                    <div class="header-logo col-auto">
                        <a href="{{route('index')}}"><img src="{{asset('customer/logo.png')}}" alt="Logo"
                                height="20px"></a>
                    </div>
                    <!--Logo End-->
                                ...
                                <li><a href="{{route('shop')}}">Shop</a>
                                    <ul class="mega-menu">
                                        ...
                                        <li class="mega-menu-img w-50">
                                            <a href="#"><img src="{{asset('customer/images/news-letter.webp')}}"
                                                    alt=""></a>
                                        </li>
                                    </ul>
                                </li>
                                <li><a href="#">Pages</a>
                                    <ul class="mega-menu">
                                        ...
                                        <li class="mega-menu-img">
                                            <a href="#"><img src="{{asset('customer/images/banner/23.webp')}}"
                                                    alt="" /></a>
                                        </li>
                                    </ul>
                                </li>
                    ...
                    <div class="col-auto d-flex">
                        ...
                        <div class="header-search dropdown">
                            <button data-bs-toggle="dropdown" class="dropdown-toggle"><i
                        ...
                        <div class="header-cart dropdown">
                            <button data-bs-toggle="dropdown" class="dropdown-toggle"><i
                                    class="fa fa-shopping-cart"></i><span class="num">2</span></button>
                            <div class="header-cart-dropdown dropdown-menu">
                                <ul class="header-cart-product">
                                    <li>
                                        <a href="product-details.html" class="image"><img
                                                src="{{asset('customer/images/cart-img/1.webp')}}" alt=""></a>
                                        <div class="content">
                                    ...
                                    <li>
                                        <a href="product-details.html" class="image"><img
                                                src="{{asset('customer/images/cart-img/2.webp')}}" alt=""></a>
                                        <div class="content">
                                ...
                                <div class="header-cart-buttons">
                                    <a class="button" href="{{route('checkout')}}">Checkout <i
